...
# 添加远程仓库（⚠️ 替换yourusername为你的GitHub用户名）
...
访问 `https://github.com/yourusername/ha-daily-brief` 确认代码已上传。
...
2. 添加: `https://github.com/yourusername/ha-daily-brief`
3. 类别: Integration
4. 搜索"Daily Brief"安装
...
1. 提交更改:
   - Commit message: `Add yourusername/ha-daily-brief`
2. 点击 **"Pull request"**
3. 标题: `Add yourusername/ha-daily-brief`
4. 说明:
```markdown
## 新集成: Daily Brief
...
**仓库**: https://github.com/yourusername/ha-daily-brief
**类型**: Integration
**类别**: News & Information
